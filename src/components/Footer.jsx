  ...
  return (
    <footer id="contact" className="text-white">
      ...
      <div className="flex h-[5px]">
        <span className="flex-1" style={{ background: '#00AEEF' }} />
        <span className="flex-1" style={{ background: '#EC008C' }} />
        <span className="flex-1" style={{ background: '#FFD200' }} />
        <span className="flex-1" style={{ background: '#767678' }} />
      </div>

      <div className="bg-navydeep pt-14 md:pt-20 pb-8">
        <div className="max-w-7xl mx-auto px-5 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 pb-10 md:pb-14 border-b border-white/10">

            <div>
              {/* Added -ml-3 to optically align the graphic with the text below */}
              <div className="inline-block mb-6 w-full">
                <img src="logo.png" alt="Mahajana Printers" className="-ml-3 w-[320px] md:w-[420px] max-w-full h-auto object-contain" />
              </div>
